  ...
  return (
    <div className="min-h-screen bg-green-900 flex items-center justify-center px-6">
      <div className="max-w-md w-full bg-white/90 p-8 rounded-xl">
        ...
        <p className="text-gray-600 mb-6">Return to your home’s nervous system profile.</p>
        ...
        <button onClick={handleLogin} className="w-full bg-green-800 text-white py-3 rounded-lg">Sign in</button>
      </div>
    </div>
  )
}
