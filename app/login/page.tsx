        ...
        <form onSubmit={handleAuth} className="space-y-4">
          ...
          {message && (
            <p className={`text-sm font-medium p-3 rounded-lg text-center ${
              message.includes('Check') || message.includes('sent') ? 'bg-green-100 text-green-800' : 'bg-red-50 text-red-600'
            }`}>
              {message}
            </p>
          )}
          ...
          <div className="flex flex-col gap-3 pt-4">
            ...
            <div className="flex flex-col gap-1">
              <button 
                ...
                className="w-full py-2 text-xs uppercase tracking-widest text-center text-[#1b270e]/60 hover:text-[#1b270e] transition-colors font-bold"
              >
