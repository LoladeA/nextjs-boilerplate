  ...
  return (
    <div className="min-h-screen bg-[#1b270e] text-[#c9ccbb] font-sans selection:bg-[#b5a642] selection:text-[#1b270e]">
      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center text-center px-4 pt-24 pb-12">
        ...
        <p className="text-lg md:text-xl text-[#c9ccbb]/70 mb-10 max-w-3xl animate-fade-in-up delay-200 leading-relaxed">
          Discover how your home environment affects your wellbeing. Get personalised recommendations based on neuropsychology principles to create spaces that enhance focus, reduce stress, and improve your quality of life.
        </p>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        <h2 className="text-sm font-bold uppercase tracking-widest text-[#b5a642] mb-12 text-center">What It Is</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="p-8 rounded-3xl bg-[#b5a642]/10 border border-[#b5a642]/20 hover:border-[#b5a642]/40 transition-all backdrop-blur-sm md:col-span-2 lg:col-span-2">
            ...
            <ul className="text-[#c9ccbb]/70 text-sm space-y-2">
      ...
      <section className="py-20 px-6 text-center">
        ...
        <p className="text-[#c9ccbb]/60 text-sm max-w-xl mx-auto mb-8">
