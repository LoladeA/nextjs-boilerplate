...
export default function AssessmentStep3() {
  ...
  const questions = [
    {
      key: 'spatial_avoidance',
      label: 'Spatial Avoidance: I catch myself avoiding certain rooms because of the “vibe” or how they make me feel.'
    },
    {
      key: 'mental_switch_off',
      label: 'Mental Switch-off: The state of my home makes it difficult to “clock off” mentally at the end of the day.'
    },
    {
      key: 'rest_deficit',
      label: 'Rest Deficit: I feel less rested after spending time in areas designated for relaxation.'
    }
  ]
