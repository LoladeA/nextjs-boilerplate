...
export default function AssessmentStep3() {
  ...
  const questions = [
    { key: 'spatial_avoidance', label: 'Spatial Avoidance: I catch myself avoiding certain rooms because of the vibe or how they make me feel.' },
    { key: 'mental_switch_off', label: 'Mental Switch-off: The state of my home makes it difficult to clock off mentally at the end of the day.' },
    { key: 'rest_deficit', label: 'Rest Deficit: I feel less rested after spending time in areas designated for relaxation.' }
  ]
  ...
  return (
    <div className="min-h-screen p-6 bg-[#1b270e] text-[#c9ccbb]">
      <div className="max-w-2xl mx-auto py-12">
        <h1 className="text-2xl font-serif mb-2 text-[#b5a642]">Part 3: Behavioural Data</h1>
        ...
        <div className="flex gap-4 mt-12">
          <button onClick={() => router.push('/assessments/step2')} className="flex-1 py-4 border border-[#c9ccbb]/20 text-[#c9ccbb] rounded-full font-medium hover:bg-[#c9ccbb]/5">Previous</button>
