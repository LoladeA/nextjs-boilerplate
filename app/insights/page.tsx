      ...
      <div className="md:ml-64 min-h-screen p-6 md:p-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {articles.map((article, i) => (
            <div key={i} className="glass-panel p-8 rounded-2xl group cursor-pointer hover:bg-[#c9ccbb]/5 transition-all">
              <div className="flex justify-between items-start mb-6">
                ...
                <ArrowUpRight className="text-[#c9ccbb]/20 group-hover:text-[#b5a642] transition-colors" size={20} />
              </div>
              
              <h3 className="text-xl font-serif text-[#c9ccbb] mb-3 group-hover:text-white transition-colors">
                {article.title}
              </h3>
              ...
              <div className="flex items-center gap-2 text-[#c9ccbb]/40 text-xs uppercase tracking-widest">
                <BookOpen size={12} />
                {article.readTime}
              </div>
            </div>
