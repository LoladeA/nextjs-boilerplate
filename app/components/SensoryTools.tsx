...
export default function SensoryTools() {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      {/* 2. NOISE LEVEL - NOW ACTIVE */}
      <Link href="/tools/noise-meter" className="block group">
        <div className="p-6 rounded-2xl bg-[#1b270e] border border-[#c9ccbb]/10 hover:border-[#b5a642]/50 transition-all h-full relative overflow-hidden">
          <div className="absolute top-0 right-0 p-4 opacity-0 group-hover:opacity-10 transition-opacity">
            <Mic size={48} />
          </div>
          ...
          <h4 className="text-[#c9ccbb] font-serif text-lg mb-1 group-hover:text-[#b5a642] transition-colors">Noise Level</h4>
