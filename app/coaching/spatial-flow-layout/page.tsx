  ...
  useEffect(() => {
    async function checkAccess() {
      try {
        ...
        setIsAuthorized(tier === 'blueprint' && 5 <= mod)
      } catch {
  ...
  if (!isAuthorized) return (
    <div className="min-h-screen bg-[#1b270e] font-sans flex flex-col items-center justify-center text-center p-12">
      ...
      <h2 className="text-2xl font-serif text-[#c9ccbb] mb-4 max-w-sm leading-snug">
        {currentModule < 5
          ? 'Complete Module 4 to unlock this module.'
      ...
      <main className="md:ml-64 min-h-screen p-6 md:p-12 lg:p-20">
        <div className="max-w-3xl mx-auto text-[#c9ccbb]">
          ...
          <header className="mb-14 border-l-4 border-[#b5a642] pl-8">
            ...
            <h1 className="text-3xl md:text-4xl font-serif mb-3 leading-tight">Spatial Flow and Layout</h1>
            <p className="text-[#c9ccbb]/60 text-sm leading-relaxed">Architectural alignment with biological movement.</p>
          </header>
          ...
          <div className="space-y-3 mb-14">
              <Link
                key="week-1"
                href="/coaching/spatial-flow-layout/week-1"
              ...
              >
                ...
                <div className="flex-1">
                  <span className="text-[#c9ccbb]/80 text-sm leading-snug group-hover:text-[#c9ccbb] transition-colors">Week 1: Spatial Cognition and the Navigating Nervous System</span>
                </div>
                <ArrowRight size={14} className="text-[#b5a642]/40 group-hover:text-[#b5a642] group-hover:translate-x-1 transition-all shrink-0" />
              </Link>
              <Link
                key="week-2"
                href="/coaching/spatial-flow-layout/week-2"
                className="group flex items-center gap-5 p-5 rounded-2xl border border-[#c9ccbb]/10 bg-[#000]/15 hover:border-[#b5a642]/40 hover:bg-[#b5a642]/5 transition-all duration-300"
              >
                ...
                <div className="flex-1">
                  <span className="text-[#c9ccbb]/80 text-sm leading-snug group-hover:text-[#c9ccbb] transition-colors">Week 2: When Space Works Against You</span>
                </div>
                <ArrowRight size={14} className="text-[#b5a642]/40 group-hover:text-[#b5a642] group-hover:translate-x-1 transition-all shrink-0" />
              </Link>
              <Link
                key="week-3"
                href="/coaching/spatial-flow-layout/week-3"
                className="group flex items-center gap-5 p-5 rounded-2xl border border-[#c9ccbb]/10 bg-[#000]/15 hover:border-[#b5a642]/40 hover:bg-[#b5a642]/5 transition-all duration-300"
              >
                ...
                <div className="flex-1">
                  <span className="text-[#c9ccbb]/80 text-sm leading-snug group-hover:text-[#c9ccbb] transition-colors">Week 3: From Spatial Diagnosis to Deliberate Intervention</span>
                </div>
                <ArrowRight size={14} className="text-[#b5a642]/40 group-hover:text-[#b5a642] group-hover:translate-x-1 transition-all shrink-0" />
              </Link>
              <Link
                key="week-4"
                href="/coaching/spatial-flow-layout/week-4"
                className="group flex items-center gap-5 p-5 rounded-2xl border border-[#c9ccbb]/10 bg-[#000]/15 hover:border-[#b5a642]/40 hover:bg-[#b5a642]/5 transition-all duration-300"
              >
                ...
                <div className="flex-1">
                  <span className="text-[#c9ccbb]/80 text-sm leading-snug group-hover:text-[#c9ccbb] transition-colors">Week 4: The Home as a Coherent Nervous System</span>
                </div>
                <ArrowRight size={14} className="text-[#b5a642]/40 group-hover:text-[#b5a642] group-hover:translate-x-1 transition-all shrink-0" />
              </Link>
          </div>
          ...
          >
            <Link href="/coaching/colour-psychology" className="flex items-center gap-2 text-[#c9ccbb]/50 hover:text-[#b5a642] text-[10px] font-bold uppercase tracking-widest transition-colors">
              <ChevronLeft size={13} /> Module 4
            </Link>
            <Link href="/coaching/biophilic-design" className="flex items-center gap-2 text-[#b5a642] hover:text-white text-[10px] font-bold uppercase tracking-widest transition-colors">Module 6 <ArrowRight size={13} /></Link>
          </div>
