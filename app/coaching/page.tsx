...
import { Lock, BookOpen, ChevronRight, Sparkles, ArrowLeft } from 'lucide-react'
      ...
      <div className="md:ml-64 min-h-screen p-6 md:p-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-[#c9ccbb]/60 max-w-2xl">
            Move from awareness to regulation. A sequenced curriculum to align your environment with your biology.
          </p>
        </div>
