...
import { Camera, Brain, Loader2, ScanEye, CheckCircle, Lock, Lightbulb, Zap, Activity } from 'lucide-react'
...
export default function AuditRoom() {
  ...
  const checkSubscription = async () => {
    ...
    if (user) {
      // Logic placeholder for subscription check
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="glass-panel p-8 rounded-3xl border border-[#c9ccbb]/10 bg-[#000]/20 relative overflow-hidden h-fit">
               ...
               <div className="mt-6 flex justify-center">
                 <button onClick={handleAnalyze} disabled={!file || status === 'analysing' || !isSubscribed}
                ...
                {status === 'success' && result ? (
                    <div className="glass-panel p-8 rounded-3xl border border-[#b5a642]/30 bg-[#1b270e] animate-fade-in-up">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-[#c9ccbb]/50 text-xs uppercase tracking-widest">Chromatic Load Audit</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-8">
                            ...
                            <div className="p-4 bg-[#000]/30 rounded-xl border border-[#c9ccbb]/10">
                                <span className="text-[#c9ccbb]/40 text-[10px] font-bold uppercase tracking-widest block mb-1">Circadian Impact</span>
                                <span className="text-xl font-serif text-[#c9ccbb]">{result.circadianTag}</span>
                            </div>
                        </div>
                    ...
                    <div className="h-full border-2 border-dashed border-[#c9ccbb]/5 rounded-3xl flex flex-col items-center justify-center p-12 text-center opacity-50">
                        ...
                        <p className="text-[#c9ccbb]/40 text-sm max-w-xs leading-relaxed">
                            Upload a photo to decode the chromatic load and circadian impact of your room.
                        </p>
                    </div>
                )}
            </div>
